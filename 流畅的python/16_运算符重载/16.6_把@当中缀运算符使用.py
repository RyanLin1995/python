...
class Vector:
    ...
    # tag::VECTOR_V7_MATMUL[]
    def __matmul__(self, other: Sequence):  # 矩阵乘法
        if isinstance(other, abc.Sized) and isinstance(other, abc.Iterable):  # 利用了大鹅类型
    ...
    def __rmatmul__(self, other):
        return self @ other  # @ 符号表示矩阵运算
    # end::VECTOR_V7_MATMUL[]
