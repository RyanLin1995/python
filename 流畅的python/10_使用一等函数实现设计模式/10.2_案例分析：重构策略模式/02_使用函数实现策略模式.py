...
print(Order(joe, cart, fidelity_promo))  # fidelity_promo 未给 Joe 打折
print(Order(ann, cart, fidelity_promo))  # fidelity_promo 给 Ann 打折了

banana_cart = (
    LineItem('banana', 30, Decimal('.5')),
    LineItem('apple', 10, Decimal('1.5')),
)
print(Order(joe, banana_cart, bulk_item_promo))  # bulk_item_promo 给 Joe 打折了
