from abc import ABC, abstractmethod  # 抽象方法
...
class Order(NamedTuple):  # 为用户提供服务的上下文
    customer: Customer
...
print(Order(joe, cart, FidelityPromo()))  # FidelityPromo 未给 Joe 打折
print(Order(ann, cart, FidelityPromo()))  # FidelityPromo 给 Ann 打折了

banana_cart = (
    LineItem('banana', 30, Decimal('.5')),
    LineItem('apple', 10, Decimal('1.5')),
)
print(Order(joe, banana_cart, BulkItemPromo()))  # BulkItemPromo 给 Joe 打折了
