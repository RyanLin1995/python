...
class GoodsType(BaseModel):
    ...
    image = models.ImageField(upload_to='type', verbose_name='商品类型图片')  # 因为图片最终上传到 fastdfs 中， upload_to 选项随便填写即可

    class Meta:
        db_table = 'df_goods_type'
        verbose_name = '商品种类'
        verbose_name_plural = verbose_name  # 设置对象的复数名称，如果不设置，则为 verbose_name + “s”
