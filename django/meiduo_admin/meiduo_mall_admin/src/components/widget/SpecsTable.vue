<template>
  <div class="auther_table_wrap">
    <el-table :data="specs" border style="width:95.2%;margin:0px auto;" size="medium">
      <el-table-column prop="id" label="id" width="100">
      </el-table-column>
      <el-table-column prop="name" label="规格名称">
      </el-table-column>
      <el-table-column prop="spu" label="SPU商品名称">
      </el-table-column>
      <el-table-column prop="spu_id" label="SPU商品id">
      </el-table-column>
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button size="mini" @click="fnPopShow(scope.row.id)">编辑</el-button>
          <el-button size="mini" type="danger" @click="fnDelSpecs(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
